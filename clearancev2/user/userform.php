	...
	<div class="formbold-form-wrapper">
      ...
      Draft No
        ...
        disabled
		  ...
		  <div>
			<label for="lastname" class="formbold-form-label"> BAYAN No </label>
			<input
			  type="text"
			  name="lastname"
			  id="lastname"
      ...
      TO
		...
		<div class="formbold-input-flex">
		  ...
		  <div>
			<label for="area" class="formbold-form-label"> Creation Date</label>
			<input
			  type="text"
			  name="area"
			  id="area"
		...
		<button class="formbold-btn">Conform</button>
	  </form>
	</div>
  </div>
  <style>
